<template>
  <div id="app" class="app">
    <h1 class="title">5-day statistics for {{displayedCity}}</h1>
    <weather-statistics/>
  </div>
</template>
